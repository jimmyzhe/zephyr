...
#define MBOX_PLIC_IRQ_SOURCE(n)                                                                    \
	static const unsigned int irq_sources##n[] = {                                             \
		DT_INST_FOREACH_PROP_ELEM_SEP(n, interrupt_names, MBOX_PLIC_IRQ_SOURCE_IDX, (,))   \
	};
#define MBOX_PLIC_DEVICE_INIT(n)                                                                   \
	...
	static mbox_callback_t                                                                     \
		mbox_callback##n[ARRAY_SIZE(irq_sources##n)];                                      \
	...
	DEVICE_DT_INST_DEFINE(n, &mbox_plic_init##n, NULL,                                         \
			      &mbox_plic_data##n, &mbox_plic_conf##n,                              \
			      PRE_KERNEL_2, CONFIG_MBOX_INIT_PRIORITY,                             \
			      &mbox_plic_driver_api);                                              \
